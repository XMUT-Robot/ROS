...
if("TRUE" STREQUAL "TRUE")
  set(beginner_tutorials_SOURCE_PREFIX /home/yobot/ROS/catkin_ws/src/beginner_tutorials)
  set(beginner_tutorials_DEVEL_PREFIX /home/yobot/ROS/catkin_ws/devel)
  ...
  set(beginner_tutorials_INSTALL_PREFIX /home/yobot/ROS/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'yobot <yobot@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/yobot/ROS/catkin_ws/src/beginner_tutorials/${idir}'.  Ask the maintainer 'yobot <yobot@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/yobot/ROS/catkin_ws/devel/lib;/home/yobot/ROS/catkin_ws/devel/lib;/home/yobot/handsfree/devel/lib;/home/yobot/yobot/devel/lib;/home/yobot/ROS/catkin_ws2/devel/lib;/opt/ros/indigo/lib)
