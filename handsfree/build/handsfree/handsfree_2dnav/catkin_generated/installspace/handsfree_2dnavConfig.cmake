...
if("FALSE" STREQUAL "TRUE")
  set(handsfree_2dnav_SOURCE_PREFIX /home/win/handsfree/src/handsfree/handsfree_2dnav)
  set(handsfree_2dnav_DEVEL_PREFIX /home/win/handsfree/devel)
  ...
  set(handsfree_2dnav_INSTALL_PREFIX /home/win/handsfree/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'handsfree_2dnav' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/win/handsfree/install/${idir}'.  Ask the maintainer 'luke_liao <luke_liao@126.com>' to fix it.")
    endif()
