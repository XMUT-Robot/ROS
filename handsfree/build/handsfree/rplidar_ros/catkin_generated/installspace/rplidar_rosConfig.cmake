...
if("FALSE" STREQUAL "TRUE")
  set(rplidar_ros_SOURCE_PREFIX /home/yobot/ROS/handsfree/src/handsfree/rplidar_ros)
  set(rplidar_ros_DEVEL_PREFIX /home/yobot/ROS/handsfree/devel)
  ...
  set(rplidar_ros_INSTALL_PREFIX /home/yobot/ROS/handsfree/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rplidar_ros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/yobot/ROS/handsfree/install/${idir}'.  Ask the maintainer 'Ling <mickey.leen@gmail.com>' to fix it.")
    endif()
