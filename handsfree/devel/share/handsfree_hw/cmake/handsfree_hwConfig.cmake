...
if("TRUE" STREQUAL "TRUE")
  set(handsfree_hw_SOURCE_PREFIX /home/yobot/ROS/handsfree/src/handsfree/handsfree_hw)
  set(handsfree_hw_DEVEL_PREFIX /home/yobot/ROS/handsfree/devel)
  ...
  set(handsfree_hw_INSTALL_PREFIX /home/yobot/ROS/handsfree/install)
...
if(NOT "/home/yobot/ROS/handsfree/src/handsfree/handsfree_hw/include " STREQUAL " ")
  set(handsfree_hw_INCLUDE_DIRS "")
  set(_include_dirs "/home/yobot/ROS/handsfree/src/handsfree/handsfree_hw/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'handsfree_hw' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/yobot/ROS/handsfree/src/handsfree/handsfree_hw/${idir}'.  Ask the maintainer 'luke_liao <luke_liao@126.com>' to fix it.")
    endif()
